...
[ExecuteInEditMode]
public class ArcLightBinder : VFXBinderBase
{
    ...
    {
        return "Position : " + property.ToString() + " -> " + target;
    }

    public override void UpdateBinding(VisualEffect component)
    {
        component.SetVector3(property, target.position + new Vector3(0, 3, 0));
    }
    ...
    protected ExposedProperty m_Property = "Pos1";
