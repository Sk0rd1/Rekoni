...
public class PSM_Spell : SpellUniversal
{
    ...
    private string effectName = "PSM/Circle";
    ...
    IEnumerator ShieldMove()
    {
        ...
        PSM psm = buffEffect.GetComponent<PSM>();
        psm.SetValues(slow, (float)1f / numOfHealPerSecond);
